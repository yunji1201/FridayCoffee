package com.fridayCoffee._1._68_gameMap;
...
class Solution {
    ...
    private void dfs() {
        ...
        queue.add(new MyCharacter(0, 0, 1)); // 위치좌표, 지난칸수
        //visited 처리
        graph[0][0] = 0;
        ...
        while (!queue.isEmpty()) {
            ...
            MyCharacter tempCharacter = queue.poll(); // poll : 큐 맨 앞에 있는 값 반환 후 삭제 / 큐가 비어있을 경우 null 반환
